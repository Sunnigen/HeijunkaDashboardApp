...
namespace HeijunkaFrontEnd.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_heijunkauser", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_identityuserclaim_string_heijunkauser_user_id",
                        column: x => x.user_id,
                        principalSchema: "public",
                        principalTable: "heijunkauser",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_identityuserlogin_string_heijunkauser_user_id",
                        column: x => x.user_id,
                        principalSchema: "public",
                        principalTable: "heijunkauser",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_identityusertoken_string_heijunkauser_user_id",
                        column: x => x.user_id,
                        principalSchema: "public",
                        principalTable: "heijunkauser",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_identityuserrole_string_heijunkauser_user_id",
                        column: x => x.user_id,
                        principalSchema: "public",
                        principalTable: "heijunkauser",
                        principalColumn: "id",
